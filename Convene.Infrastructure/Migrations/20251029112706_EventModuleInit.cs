...
{
    /// <inheritdoc />
    public partial class EventModuleInit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThresholdPercentage = table.Column<int>(type: "integer", nullable: true),
                    PriceIncreasePercent = table.Column<decimal>(type: "numeric", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DynamicPricingRules_TicketTypes_TicketTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DynamicPricingRules_TicketTypeId",
